...
70-line no-dep wrapper around webcrypto AES-GCM. Encrypt and decrypt arbitrary data.
...
`siv.js` exports AES-GCM-SIV (RFC 8452 nonce-misuse resistance) is available in `siv` directory of the repository.
